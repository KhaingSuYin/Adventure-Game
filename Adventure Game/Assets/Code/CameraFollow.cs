...
public class CameraFollow : MonoBehaviour
{
    ...
    Vector3 offset = new Vector3(5.0f, 10.0f, 0);
    Vector3 currOffset = new Vector3(5.0f, 10.0f, 0);
    ...
    void LateUpdate()
    {
        ...
        currOffset = Vector3.SmoothDamp(currOffset, targetOffset, ref velocity, 3.0f);
